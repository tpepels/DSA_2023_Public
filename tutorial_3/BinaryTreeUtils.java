...
public class BinaryTreeUtils {
    ...
    public static <E extends Comparable<E>> int computeOddNumbersBetweenLevels(BinaryTree<E> tree, int levelMin, int levelMax){
    ...
    private static <E extends Comparable<E>> int computeOddNumbersFromNodeBetweenLevels(BinaryTreeNode<E> treeNode, 
        ...
        if(treeNode==null){
            ...
            if(currentLevel+1 <= levelMax){
                leftContribution = computeOddNumbersFromNodeBetweenLevels(treeNode.getLeftChild(), levelMin, levelMax, currentLevel+1);
                rightContribution = computeOddNumbersFromNodeBetweenLevels(treeNode.getRightChild(), levelMin, levelMax, currentLevel+1);
            }
