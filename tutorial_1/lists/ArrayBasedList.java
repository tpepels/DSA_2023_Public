...
public class ArrayBasedList<E> implements ListADT<E> {
    ...
    public ArrayBasedList(){
        // Initializes the class attributes, for an empty list in an array of 10 elements
        N = 10;
    ...
    /**
     * Support method, check if the array is full, in case increases its dimension by 10 and copies all the elements from the old array
     */
